...
import { ArrowLeft, Calendar, Code, Layers, Zap, Sun, Moon, CreditCard, Shield, Smartphone } from 'lucide-react'
import Image from 'next/image'

const project = {
  id: "dukhanbank",
  title: 'Dukhan Bank',
  description: 'Your digital banking solution for seamless, secure, and convenient financial management.',
            ...
            >
              {activeSection === 'overview' && (
                <div className="grid md:grid-cols-2 gap-8">
                  <div>
                    <h2 className="text-2xl font-semibold mb-4 text-blue-600 dark:text-blue-400">About Dukhan Bank</h2>
                    <p className="text-gray-600 dark:text-gray-400 mb-4">
                      Dukhan Banks mobile app is a comprehensive digital banking solution that brings the power of modern banking to your fingertips. It offers a wide range of features designed to make your financial management seamless, secure, and convenient.
                    </p>
                    <p className="text-gray-600 dark:text-gray-400">
                      With this app, you can perform various banking operations, from checking your account balance to making transfers and payments, all from the comfort of your smartphone.
                    </p>
                  </div>
              ...
              {activeSection === 'features' && (
                <div className="grid md:grid-cols-3 gap-6">
                  {[
                    { icon: CreditCard, title: 'Account Management', description: 'View balances, transactions, and manage your accounts easily.' },
                    { icon: Shield, title: 'Secure Transactions', description: 'Perform secure fund transfers and bill payments anytime, anywhere.' },
                    { icon: Smartphone, title: 'Mobile Services', description: 'Access mobile top-up, Western Union, and other banking services on-the-go.' },
                  ].map((feature, index) => (
