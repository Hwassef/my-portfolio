...
import { ArrowLeft, Sun, Moon, Smartphone, Shield, CreditCard, ExternalLink, ChevronLeft, ChevronRight } from 'lucide-react'
...
const project = {
  ...
  techStack: ['Flutter', 'Dart', 'Firebase', 'Clean Architecture', 'BLoC'],
  features: [
    { icon: CreditCard, title: 'Account Management', description: 'View balances, transactions, and manage your accounts with ease.' },
...
export default function FuturisticProjectShowcase() {
  ...
  return (
    <div className={`${darkMode ? 'dark' : ''} min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-800 text-gray-900 dark:text-gray-100 transition-colors duration-300`}>
              ...
              <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-6">
                ...
                <ul className="space-y-4">
                  {project.features.map((feature, index) => (
                    ...
                    >
                      <feature.icon className="w-6 h-6 mr-3 text-blue-600 dark:text-blue-400 flex-shrink-0 mt-1" />
                      <div>
      ...
      <footer className="mt-16 bg-white/10 dark:bg-gray-900/10 backdrop-blur-md py-8">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <p className="text-gray-600 dark:text-gray-400">
            © 2023 Dukhan Bank. All rights reserved.
          </p>
          <motion.a
            href="#"
            className="inline-flex items-center text-blue-600 dark:text-blue-400 hover:text-blue-800 dark:hover:text-blue-200 mt-2"
            whileHover={{ scale: 1.05 }}
            whileTap={{ scale: 0.95 }}
          >
            Visit Dukhan Bank website
